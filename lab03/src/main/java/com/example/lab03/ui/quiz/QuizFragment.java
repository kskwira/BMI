...
import com.example.lab03.databinding.FragmentQuizBinding;
...
public class QuizFragment extends Fragment {
    ...
    public int correctAnswers; // number of correct guesses
...
//                    fileNameList.add(path.replace(".png", ""));
            ...
            // Set the region
            String[] paths = assets.list("Europe");
...
//                    quizResults.show(getFragmentManager(), "quiz results");
                    ...
                    new MyCustomDialog().show(getChildFragmentManager(), MyCustomDialog.TAG);
                }
